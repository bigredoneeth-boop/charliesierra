...
export function MessageInput({
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      ...
      // CRITICAL: ensure the encrypted blob has byteOffset=0 before passing to
      // the backend serializer. Create a fresh Uint8Array backed by its own
      // ArrayBuffer with an element-by-element copy — guarantees the Candid
      // vec nat8 serializer sees the full payload from index 0.
